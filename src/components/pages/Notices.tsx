              ...
              <div className="flex items-start justify-between">
                <div className="flex-1">
                  <div className="flex items-center space-x-3 mb-3">
                    <h3
                      className={`text-lg font-semibold ${notice.isRead ? 'text-gray-600' : 'text-gray-800'}`}
                    >
                      {notice.title}
                    </h3>
                    {!notice.isRead && (
                    ...
                    <span
                      className={`px-3 py-1 text-xs font-medium rounded-full border ${getPriorityColor(notice.priority)}`}
                    >
